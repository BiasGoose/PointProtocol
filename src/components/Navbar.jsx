			...
			<div className='flex justify-between items-center py-6 md:justify-between md:space-x-10'>
				...
				<div className='flex items-center space-x-3'>
					<div className='hidden md:flex justify-center'>
						<button className='bg-primary dark:bg-white dark:hover:text-white dark:text-primary dark:hover:bg-transparent dark:border-2 
																dark:border-white rounded-lg text-white w-[100px] h-[40px] border-2 duration-200 hover:bg-transparent 
														  	hover:border-primary hover:text-primary font-bold'>Build</button>
					</div>
					<div className='cursor-pointer duration-150 hover:scale-105' onClick={() => darkModeToggle()}>
